      ...
      {enough ? (
        ...
        <div className="rounded-lg border border-dashed border-border bg-card p-10 text-center">
          ...
          <p className="mx-auto mt-2 max-w-prose text-small text-muted-foreground">
            Compare 2 to 4 processors side by side: pricing, payment methods, integrations,
            features, and company facts. Use the picker above, or &ldquo;Add to compare&rdquo; from
            any processor card.
          </p>
        </div>
      )}
