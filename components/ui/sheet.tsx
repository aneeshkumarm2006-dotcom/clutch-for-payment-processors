...
const sheetVariants = cva(
  "fixed z-50 gap-4 bg-card p-6 shadow-pop transition ease-in-out data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:duration-250 data-[state=open]:duration-250",
  {
    variants: {
      side: {
...
>(({ className, ...props }, ref) => (
  <SheetPrimitive.Title ref={ref} className={cn("text-h3 text-foreground", className)} {...props} />
));
