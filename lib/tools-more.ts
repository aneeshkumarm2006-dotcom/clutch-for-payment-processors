...
export const MORE_TOOLS: ToolDef[] = [
  {
    ...
    description: "Convert an MCA factor rate into a real APR. Enter the advance, factor, holdback and card volume to see total cost, payoff time and the annual rate.",
  ...
  },
  {
    ...
    title: "Merchant Category Code Lookup: 290 Verified US MCCs",
    description: "Search 290 real US merchant category codes by number or description, filter by industry, and see which MCCs acquirers commonly treat as high risk.",
  ...
  },
  {
    ...
    title: "Restaurant Credit Card Fee Calculator (Tips Included)",
    description: "Work out what card processing costs your restaurant, including the fee you pay on every tip. Verified US interchange, effective rate, and cost per cover.",
  ...
  },
  {
    ...
    title: "Credit Card Surcharge Calculator and State Law Guide",
    description: "Work out your surcharge, the customer total, your net deposit and the residual you still absorb after processing the larger amount. Plus a dated state table.",
  ...
  },
  {
    ...
    title: "Reverse Credit Card Fee Calculator (Gross Up Your Price)",
    description: "Work out what to charge so an exact amount lands in your account. Verified Stripe, PayPal and Square rates, the gross up formula, and US surcharge rules.",
  ...
  },
  {
    ...
    title: "Chargeback Ratio Calculator: VAMP and ECM Thresholds",
    description: "Score your chargeback ratio against the current Visa VAMP and Mastercard ECM thresholds, then price what one chargeback truly costs your US business.",
  ...
  },
  {
    ...
    title: "Rolling Reserve Calculator for High-Risk Merchants",
    description: "Work out exactly how much cash a rolling reserve locks up. Enter monthly volume, reserve percent and hold months for a month-by-month release timeline.",
  ...
  },
  {
    ...
    title: "Payout Date Calculator: When Card Money Hits Your Bank",
    description: "Enter your processor, the date and time of the sale and your payout speed. Get the exact settlement date, adjusted for weekends and Fed bank holidays.",
  ...
  },
  {
    ...
    title: "Involuntary Churn Calculator: Failed Payment Recovery",
    description: "Separate involuntary churn from blended churn. Enter subscribers, ARPU, decline rate and recovery rate to size the revenue failed payments cost you.",
  ...
  },
  {
    ...
    title: "POS Terminal Lease vs Buy Calculator: See the Real Rate",
    description: "Compare a quoted POS terminal lease against buying the device outright. See total paid, the difference, the implied interest rate and your break-even month.",
